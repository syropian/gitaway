...
var stub = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_local_storage__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_pages_Auth__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_pages_Auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_pages_Auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_pages_Dashboard__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_pages_Dashboard___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_pages_Dashboard__);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  ...
  routes: [{
    path: "/",
    name: "Auth",
    component: __WEBPACK_IMPORTED_MODULE_3__components_pages_Auth___default.a,
    beforeEnter: function beforeEnter(to, from, next) {
      if (to.query.token) {
        var expirySeconds = parseInt(to.query.token_expiry, 10);
        var now = new Date();
        now.setSeconds(now.getSeconds() + expirySeconds);
        __WEBPACK_IMPORTED_MODULE_2_local_storage___default()("jwt_expiry", now);
        __WEBPACK_IMPORTED_MODULE_2_local_storage___default()("jwt", to.query.token);
        next("dashboard");
      } else {
        next();
      }
    ...
    children: [{
      ...
      beforeEnter: function beforeEnter(to, from, next) {
        __WEBPACK_IMPORTED_MODULE_2_local_storage___default.a.remove("jwt");
        next("/");
      }
    }]
  }, {
    path: "/dashboard",
    name: "Dashboard",
    component: __WEBPACK_IMPORTED_MODULE_4__components_pages_Dashboard___default.a,
    meta: {
      requiresAuth: true
    }
  }]
...
router.beforeEach(function (to, from, next) {
  var token = __WEBPACK_IMPORTED_MODULE_2_local_storage___default()("jwt");
  var expiry = __WEBPACK_IMPORTED_MODULE_2_local_storage___default()("jwt_expiry");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_App__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(67);
...
Object.defineProperty(__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype, '$bus', {
  get: function get() {
...
Component.options.__file = "resources/assets/js/components/pages/Auth.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d0f9d0a", Component.options)
  } else {
    hotAPI.reload("data-v-6d0f9d0a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6d0f9d0a", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Dashboard',
  computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(['user'])),
  methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])(['fetchUser'])),
  mounted: function mounted() {
    this.fetchUser();
  }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("Henlo " + _vm._s(_vm.user.username))])
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_user__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_es6_promise__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_local_storage__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_local_storage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_local_storage__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_mutation_types__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_client__ = __webpack_require__(74);
...
var getters = {
  ...
  isAuthenticated: function isAuthenticated(state) {
    return !!__WEBPACK_IMPORTED_MODULE_2_local_storage___default()('jwt');
  }
};

var mutations = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, __WEBPACK_IMPORTED_MODULE_3__store_mutation_types__["a" /* SET_USER */], function (state, user) {
  state.user = user;
});
...
var actions = {
  fetchUser: function fetchUser(_ref) {
    ...
    return __WEBPACK_IMPORTED_MODULE_4__store_client__["a" /* default */].withAuth().get('/api/auth/me').then(function (res) {
      commit(__WEBPACK_IMPORTED_MODULE_3__store_mutation_types__["a" /* SET_USER */], res);
    });
  }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_local_storage__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_local_storage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_local_storage__);
...
verbs.forEach(function (verb) {
  client[verb] = function (url) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1_es6_promise__["Promise"](function (resolve, reject) {
      return __WEBPACK_IMPORTED_MODULE_2_axios___default()({
        method: verb,
        url: url,
        data: data,
        headers: client.auth && __WEBPACK_IMPORTED_MODULE_3_local_storage___default()('jwt') ? __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, { Authorization: 'Bearer ' + __WEBPACK_IMPORTED_MODULE_3_local_storage___default()('jwt') }, headers) : headers
      }).then(function (res) {
        client.auth = false;
        resolve(res.data);
